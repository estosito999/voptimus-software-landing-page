...
export const services: Service[] = [
  ...
  {
    slug: 'sistemas-facturacion-computarizada-en-linea',
    icon: '◈',
    iconStyle: 'violet',
    title: 'Sistemas de Facturación Computarizada en Línea',
    description: 'Sistemas de facturación electrónica para cumplir con las normativas fiscales y optimizar el proceso de facturación.',
    details: [
